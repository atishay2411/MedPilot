...
CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    CapabilityDefinition(
        ...
        fields=(
            ...
            CapabilityField("country", "Optional country of birth/residence.", required=False),
        ),
        write=True,
    ...
    CapabilityDefinition(
        ...
        fields=(
            ...
            CapabilityField("city_village", "Optional city.", required=False),
            CapabilityField("country", "Optional country of birth/residence.", required=False),
            CapabilityField("conditions", "List of conditions with condition_name, clinical_status, verification_status.", required=False),
