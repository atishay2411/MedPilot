...
class MedicationService:
    ...
    def list_orders_for_patient(self, patient_uuid: str) -> dict:
    ...
    def build_create_payload(self, patient_uuid: str, encounter_uuid: str, medication: dict) -> dict:
    ...
    def patch_status(self, medication_request_uuid: str, status: str) -> dict:
        return self.client.patch(
            f"/ws/fhir2/R4/MedicationRequest/{medication_request_uuid}",
            [{"op": "replace", "path": "/status", "value": status}],
        )

    def medication_dispense(self, patient_uuid: str) -> dict:
        return self.client.get("/ws/fhir2/R4/MedicationDispense", params={"patient": patient_uuid})

    def create_dispense(self, patient_uuid: str, medication_reference: str, quantity: float, unit: str, when_handed_over: str, dosage_text: str) -> dict:
